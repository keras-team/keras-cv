...
class RandomCopyPaste(base_augmentation_layer_3d.BaseAugmentationLayer3D):
    ...
    If a pasted bounding box overlaps with an existing bounding box, we do not paste that bounding box. We load 5 times max_paste_bounding_boxes to check overlap.
    If a pasted bounding box overlaps with existing point clouds, we paste the bounding box and remove the point clouds.
