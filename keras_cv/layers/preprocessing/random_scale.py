...
class RandomScale(BaseImageAugmentationLayer):
    ...
    def __init__(self, factor, interpolation="bilinear", bounding_box_format=None, **kwargs):
    ...
    def augment_image(self, image, transformation, **kwargs):
        ...
        target_size = tf.cast(tf.cast(tf.shape(image)[:2], self.compute_dtype) * transformation, tf.int32)
