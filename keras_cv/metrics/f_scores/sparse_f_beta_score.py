...
class SparseFBetaScore(keras.metrics.Metric):
    r"""Computes Sparse F-Beta score.
    ...
    >>> metric = keras_cv.metrics.SparseFBetaScore(num_classes=3, beta=2.0, threshold=0.5)
    ...
    >>> result.numpy()
    array([0.       , 0.7142857, 0.8333334], dtype=float32)
    """
    ...
    def reset_state(self):
        ...
        self.weights_intermediate.assign(tf.zeros_like(self.weights_intermediate))
