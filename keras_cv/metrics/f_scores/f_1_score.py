...
class F1Score(FBetaScore):
    ...
    >>> metric = keras_cv.metrics.F1Score(num_classes=3, threshold=0.5)
    ...
    >>> result.numpy()
    array([0.5       , 0.79999995, 0.6666667], dtype=float32)
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(num_classes, average, 1.0, threshold, **kwargs)
