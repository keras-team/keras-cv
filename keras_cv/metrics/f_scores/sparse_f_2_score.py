...
class SparseF2Score(SparseFBetaScore):
    ...
    >>> metric = keras_cv.metrics.SparseF2Score(num_classes=3, threshold=0.5)
    ...
    def __init__(
        ...
        average=None,
        threshold=None,
        name="sparse_f2_score",
        dtype=None,
        **kwargs
    ):
        super().__init__(num_classes, average, 2.0, threshold, name=name, dtype=dtype, **kwargs)
