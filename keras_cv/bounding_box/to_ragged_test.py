...
class ToRaggedTest(tf.test.TestCase):
    def test_converts_to_ragged(self):
        ...
        self.assertEqual(bounding_boxes["num_classes"][1].shape, [1])
        self.assertEqual(bounding_boxes["num_classes"][0].shape, [0])
    ...
    def test_round_trip(self):
        ...
        self.assertEqual(bounding_boxes["num_classes"][1].shape, [2])
        self.assertEqual(bounding_boxes["num_classes"][0].shape, [2])
