...
from keras_cv.models.backbones.vgg19 import vgg19_backbone as vgg19
from keras_cv.models.models_test import ModelsTest

MODEL_LIST = [
    (vgg19.VGG19Backbone, 512, {}),
]


class VGG19BackboneTest(ModelsTest, tf.test.TestCase, parameterized.TestCase):
