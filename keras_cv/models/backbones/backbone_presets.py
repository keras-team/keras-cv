...
from keras_cv.models.backbones.efficientnetv2 import (
    efficientnetv2_backbone_presets,
)
...
backbone_presets_no_weights = {
    ...
    **efficientnetv2_backbone_presets.backbone_presets_no_weights,
}

backbone_presets_with_weights = {
    **resnet_v1_backbone_presets.backbone_presets_with_weights,
    **resnet_v2_backbone_presets.backbone_presets_with_weights,
    **efficientnetv2_backbone_presets.backbone_presets_with_weights,
}
