...
register_presets(
    backbone_presets_no_weights, (ViTDetBackbone,), with_weights=False
)
register_presets(
    backbone_presets_with_weights, (ViTDetBackbone,), with_weights=True
)
register_preset(
    "vitdet_base_sa1b",
    backbone_presets_with_weights["vitdet_base_sa1b"],
    (ViTDetBBackbone,),
    with_weights=True,
)
register_preset(
    "vitdet_large_sa1b",
    backbone_presets_with_weights["vitdet_large_sa1b"],
    (ViTDetLBackbone,),
    with_weights=True,
)
register_preset(
    "vitdet_huge_sa1b",
    backbone_presets_with_weights["vitdet_huge_sa1b"],
    (ViTDetHBackbone,),
    with_weights=True,
)
