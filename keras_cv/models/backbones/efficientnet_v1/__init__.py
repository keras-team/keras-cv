...
register_presets(backbone_presets_no_weights, (EfficientNetV1Backbone, ), with_weights=False)
register_presets(backbone_presets_with_weights, (EfficientNetV1Backbone, ), with_weights=True)
