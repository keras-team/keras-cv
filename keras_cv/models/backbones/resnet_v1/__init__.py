...
register_presets(
    backbone_presets_no_weights, (ResNetBackbone,), with_weights=False
)
register_presets(
    backbone_presets_with_weights, (ResNetBackbone,), with_weights=True
)
register_preset(
    "resnet50_imagenet",
    backbone_presets_with_weights["resnet50_imagenet"],
    (ResNet50Backbone,),
    with_weights=True,
)
