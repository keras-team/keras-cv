...
def ResNeXt50_64x4d(
    ...
    **kwargs,
    ...
    return ResNeXt(
        ...
        stackwise_filters=MODEL_CONFIGS["ResNeXt50_64x4d"]["stackwise_filters"],
        stackwise_strides=MODEL_CONFIGS["ResNeXt50_64x4d"]["stackwise_strides"],
        name=name,
        include_rescaling=include_rescaling,
        include_top=include_top,
        weights=weights,
...
def ResNeXt101_32x4d(
    ...
    **kwargs,
    ...
    return ResNeXt(
        ...
        stackwise_filters=MODEL_CONFIGS["ResNeXt101_32x4d"]["stackwise_filters"],
        stackwise_strides=MODEL_CONFIGS["ResNeXt101_32x4d"]["stackwise_strides"],
        name=name,
        include_rescaling=include_rescaling,
        include_top=include_top,
        weights=weights,
...
def ResNeXt101_32x8d(
    ...
    **kwargs,
    ...
    return ResNeXt(
        ...
        stackwise_filters=MODEL_CONFIGS["ResNeXt101_32x8d"]["stackwise_filters"],
        stackwise_strides=MODEL_CONFIGS["ResNeXt101_32x8d"]["stackwise_strides"],
        name=name,
        include_rescaling=include_rescaling,
        include_top=include_top,
        weights=weights,
...
def ResNeXt101_64x4d(
    ...
    **kwargs,
    ...
    return ResNeXt(
        ...
        stackwise_filters=MODEL_CONFIGS["ResNeXt101_64x4d"]["stackwise_filters"],
        stackwise_strides=MODEL_CONFIGS["ResNeXt101_64x4d"]["stackwise_strides"],
        name=name,
        include_rescaling=include_rescaling,
        include_top=include_top,
        weights=weights,
