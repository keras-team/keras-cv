...
setattr(EfficientNetV2B0, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2B0"))
setattr(EfficientNetV2B1, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2B1"))
setattr(EfficientNetV2B2, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2B2"))
setattr(EfficientNetV2B3, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2B3"))
setattr(EfficientNetV2S, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2S"))
setattr(EfficientNetV2M, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2M"))
setattr(EfficientNetV2L, "__doc__", BASE_DOCSTRING.format(name="EfficientNetV2L"))
