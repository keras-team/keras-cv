...
from keras_cv.models import weights
...
def RegNetX002(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        weights=weights.parse_weights(weights, include_top, "regnetx002"),
...
def RegNetX004(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx004"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX006(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx006"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX008(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx008"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX016(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx016"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX032(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx032"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX040(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx040"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX064(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx064"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX080(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx080"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX120(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx120"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX160(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx160"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetX320(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnetx320"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY002(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety002"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY004(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety004"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY006(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety006"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY008(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety008"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY016(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety016"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY032(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety032"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY040(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety040"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY064(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety064"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY080(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety080"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY120(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety120"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY160(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety160"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
...
def RegNetY320(
    ...
    **kwargs,
    ...
    return RegNet(
        ...
        include_top=include_top,
        include_rescaling=include_rescaling,
        weights=weights.parse_weights(weights, include_top, "regnety320"),
        input_tensor=input_tensor,
        input_shape=input_shape,
        pooling=pooling,
        classes=classes,
