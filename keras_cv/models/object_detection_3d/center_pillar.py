...
class MultiClassHeatmapDecoder(keras.layers.Layer):
    '''
            ...
            Description:
            Decodes the predictions generated by the MultiClassDetectionHead layer. 
...
class MultiHeadCenterPillar(keras.Model):
    '''
        ...
        Description:
        This is the main model that combines the MultiClassDetectionHead and MultiClassHeatmapDecoder layers with a backbone and a voxelization layer. 
