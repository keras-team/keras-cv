...
backbone_presets_no_weights = {
    "segformer_b0": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB0 backbone."
            ),
            "params": 3719027,
    ...
    "segformer_b1": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB1 backbone."
            ),
            "params": 13682643,
    ...
    "segformer_b2": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB2 backbone."
            ),
            "params": 24727507,
    ...
    "segformer_b3": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB3 backbone."
            ),
            "params": 44603347,
    ...
    "segformer_b4": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB4 backbone."
            ),
            "params": 61373907,
      ...
      "segformer_b5": {
        "metadata": {
            "description": (
                "SegFormer model with MiTB5 backbone."
            ),
            "params": 81974227,
