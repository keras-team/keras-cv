...
from keras_cv.models import maxvit

from .models_test import ModelsTest

MODEL_LIST = [
    (maxvit.MaxViTTiny, 512, {"input_shape": (224, 224, 3)}),
    (maxvit.MaxViTSmall, 768, {"input_shape": (224, 224, 3)}),
    (maxvit.MaxViTBase, 768, {"input_shape": (224, 224, 3)}),
    (maxvit.MaxViTLarge, 1024, {"input_shape": (224, 224, 3)}),
    (maxvit.MaxViTXLarge, 1536, {"input_shape": (224, 224, 3)}),
]
