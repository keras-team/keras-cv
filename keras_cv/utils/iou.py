...
def compute_ious_for_image(boxes1, boxes2):
    ...
    `[bounding_box.LEFT, bounding_box.RIGHT, bounding_box.TOP, bounding_box.BOTTOM]`.  For example, the bounding box
    with it's left side at 100, bounding_box.RIGHT side at 200, bounding_box.TOP at 101, and
    bounding_box.BOTTOM at 201 would be represented as:
    > [100, 200, 101, 201]
